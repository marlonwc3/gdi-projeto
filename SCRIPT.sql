DROP TABLE Aloca CASCADE;
DROP TABLE Promocao_Loja CASCADE;
DROP TABLE Aluguel_Loja CASCADE;
DROP TABLE Pagamento CASCADE; 
DROP TABLE Atracao CASCADE;
DROP TABLE Evento CASCADE;
DROP TABLE Area CASCADE;
DROP TABLE Aluguel CASCADE;
DROP TABLE Telefone CASCADE;
DROP TABLE Telefone_Func CASCADE;
DROP TABLE Categoria CASCADE;
DROP TABLE Externo CASCADE;
DROP TABLE Interno CASCADE;
...
(
	...
	CONSTRAINT Interno_fkey FOREIGN KEY (CPF) REFERENCES Funcionario (CPF)
);
