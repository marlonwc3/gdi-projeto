...
VALUES ('86.814.375/0001-00', 'Roupas', 'contato@cea.com.br', 'Jovem', 'Á vista/Á prazo', TO_DATE('01/07/2014', 'dd/mm/yyyy'), 'CeA');

INSERT INTO Loja (CNPJ, Tipo, Email, Publico_alvo, Forma_de_pagamento, Data_de_abertura, Nome_da_loja) 
VALUES ('83.824.371/0001-00', 'Restaurante', 'contato@boteco.com.br', 'Adulto', 'Á vista/Á prazo', TO_DATE('12/03/2014', 'dd/mm/yyyy'), 'Boteco - Bar e Restaurante');

INSERT INTO Loja (CNPJ, Tipo, Email, Publico_alvo, Forma_de_pagamento, Data_de_abertura, Nome_da_loja) 
VALUES ('33.824.141/0002-00', 'Farmácia', 'contato@santamaria.com.br', 'Idoso', 'Á vista/Á prazo',TO_DATE('12/07/2011', 'dd/mm/yyyy'), 'Farmácia Santa Maria');

INSERT INTO Loja (CNPJ, Tipo, Email, Publico_alvo, Forma_de_pagamento, Data_de_abertura, Nome_da_loja) 
VALUES ('13.14.141/132-00', 'Restaurante', 'hablaconosco@donandaluz.com.br', 'Maratonista', 'Dinero', TO_DATE('12/09/2000', 'dd/mm/yyyy'), 'Don Andaluz');

INSERT INTO Loja (CNPJ, Tipo, Email, Publico_alvo, Forma_de_pagamento, Data_de_abertura, Nome_da_loja) 
VALUES ('13.11.111/112-00', 'Livraria', 'contato@saraiva.com.br', 'Todos', 'Á vista/Á prazo', TO_DATE('12/07/2001', 'dd/mm/yyyy'), 'Livraria Saraiva');

INSERT INTO Loja (CNPJ, Tipo, Email, Publico_alvo, Forma_de_pagamento, Data_de_abertura, Nome_da_loja) 
VALUES ('23.13.131/112-12', 'Ótica', 'contato@oticasdiniz.com.br', 'Todos', 'Á vista/Á prazo', TO_DATE('12/01/2011', 'dd/mm/yyyy'), 'Óticas Diniz');

INSERT INTO Loja (CNPJ, Tipo, Email, Publico_alvo, Forma_de_pagamento, Data_de_abertura, Nome_da_loja) 
VALUES ('23.11.121/132-11', 'Cinema', 'contato@uci.com.br', 'Jovem', 'Á vista/Á prazo', TO_DATE('01/02/2013', 'dd/mm/yyyy'), 'Cinema UCI');

INSERT INTO Loja (CNPJ, Tipo, Email, Publico_alvo, Forma_de_pagamento, Data_de_abertura, Nome_da_loja) 
VALUES ('93.15.128/112-11', 'Loja', 'contato@eletroshopping.com.br', 'Adulto', 'Á vista/Á prazo', TO_DATE('12/03/2012', 'dd/mm/yyyy'), 'Eletroshopping');

INSERT INTO Loja (CNPJ, Tipo, Email, Publico_alvo, Forma_de_pagamento, Data_de_abertura, Nome_da_loja) 
VALUES ('82.43.132/193-63', 'Mercado', 'contato@hiper.com.br', 'Todos', 'Á vista/Á prazo', TO_DATE('03/02/2010', 'dd/mm/yyyy'), 'Hiper-Bombreço');

INSERT INTO Loja (CNPJ, Tipo, Email, Publico_alvo, Forma_de_pagamento, Data_de_abertura, Nome_da_loja) 
VALUES ('58.34.321/132-43', 'Loja', 'contato@rommanel.com.br', 'Adulto', 'Á vista', TO_DATE('12/02/2014', 'dd/mm/yyyy'), 'Rommanel Jóias');

INSERT INTO Loja (CNPJ, Tipo, Email, Publico_alvo, Forma_de_pagamento, Data_de_abertura, Nome_da_loja) 
VALUES ('58.34.231/345-43', 'Livraria', 'contato@livrosa.com.br', 'Maratonista', 'Á vista', TO_DATE('11/11/2011', 'dd/mm/yyyy'), 'Livros SA');

INSERT INTO Loja (CNPJ, Tipo, Email, Publico_alvo, Forma_de_pagamento, Data_de_abertura, Nome_da_loja) 
VALUES ('49.14.321/132-43', 'Livraria', 'contato@cultura.com.br', 'Maratonista', 'Á vista', TO_DATE('03/07/2003', 'dd/mm/yyyy'), 'Cultura');

INSERT INTO Loja (CNPJ, Tipo, Email, Publico_alvo, Forma_de_pagamento, Data_de_abertura, Nome_da_loja) 
VALUES ('29.34.856/938-941', 'Eletronicos', 'contato@infobox.com.br', 'Maratonista', 'Á vista', TO_DATE('12/01/2012', 'dd/mm/yyyy'), 'Infobox');

#Pagamento

insert into Pagamento (Codigo, Data_de_Pagamento, Tipo_de_pagamento, Valor)
values (10022334, TO_DATE('12/09/2014', 'dd/mm/yyyy') , 'A vista', 1000.20);

insert into Pagamento (Codigo, Data_de_Pagamento, Tipo_de_pagamento, Valor)
values (10034, TO_DATE('12/10/2014', 'dd/mm/yyyy'), 'Boleto', 2953.70);

insert into Pagamento (Codigo, Data_de_Pagamento, Tipo_de_pagamento, Valor)
values (1004, TO_DATE('12/12/2014', 'dd/mm/yyyy'), 'Credito', 765.80);

insert into Pagamento (Codigo, Data_de_Pagamento, Tipo_de_pagamento, Valor)
values (10, TO_DATE('15/11/2014', 'dd/mm/yyyy'), 'Credito', 674.00);

insert into Pagamento (Codigo, Data_de_Pagamento, Tipo_de_pagamento, Valor)
values (1002, TO_DATE('18/10/2014', 'dd/mm/yyyy'), 'A vista', 235.50);

insert into Pagamento (Codigo, Data_de_Pagamento, Tipo_de_pagamento, Valor)
values (4, TO_DATE('19/11/2014', 'dd/mm/yyyy'), 'Boleto', 321.80);

insert into Pagamento (Codigo, Data_de_Pagamento, Tipo_de_pagamento, Valor)
values (14, TO_DATE('03/12/2014', 'dd/mm/yyyy'), 'Deposito', 500.90);

insert into Pagamento (Codigo, Data_de_Pagamento, Tipo_de_pagamento, Valor)
values (124, TO_DATE('27/12/2014', 'dd/mm/yyyy'), 'Credito', 150.10);

insert into Pagamento (Codigo, Data_de_Pagamento, Tipo_de_pagamento, Valor)
values (10334, TO_DATE('09/10/2014', 'dd/mm/yyyy'), 'A vista', 750.20);

insert into Pagamento (Codigo, Data_de_Pagamento, Tipo_de_pagamento, Valor)
values (9422334, TO_DATE('01/11/2014', 'dd/mm/yyyy'), 'Deposito', 343.20);
...
INSERT INTO Interno (CPF, CPF_Supervisor, Data_de_contratacao, Funcao, Salario) 
	VALUES ('000.000.000-1', '000.000.000-0', TO_DATE('12/07/2014', 'dd/mm/yyyy'), 'Gerente', 3000);

INSERT INTO Interno (CPF, CPF_Supervisor, Data_de_contratacao, Funcao, Salario)  
	VALUES ('000.000.000-2', '000.000.000-0',TO_DATE('11/07/2014', 'dd/mm/yyyy'), 'Atendente', 2000);

INSERT INTO Interno (CPF, CPF_Supervisor, Data_de_contratacao, Funcao, Salario) 
	VALUES ('000.000.000-3', '000.000.000-0', TO_DATE('12/01/2011', 'dd/mm/yyyy'), 'Segurança', 1000);

INSERT INTO Interno (CPF, CPF_Supervisor, Data_de_contratacao, Funcao, Salario)  
	VALUES ('000.000.000-4', '000.000.000-0', TO_DATE('03/07/2010', 'dd/mm/yyyy'), 'Segurança', 2500);

INSERT INTO Interno (CPF, CPF_Supervisor, Data_de_contratacao, Funcao, Salario)  
	VALUES ('000.000.000-5', '000.000.000-2', TO_DATE('17/07/2004', 'dd/mm/yyyy'), 'Gerente', 500);
...
INSERT INTO Externo (Loja_CNPJ,Funcionario_CPF,Grau_de_responsabilidade,Tipo_de_acesso) VALUES('86.814.375/0001-00', '000.000.000-6','Baixo','Total');
INSERT INTO Externo (Loja_CNPJ,Funcionario_CPF,Grau_de_responsabilidade,Tipo_de_acesso) VALUES('86.814.375/0001-00', '000.000.000-7','Alto','Total');
INSERT INTO Externo (Loja_CNPJ,Funcionario_CPF,Grau_de_responsabilidade,Tipo_de_acesso) VALUES('23.13.131/112-12', '000.000.000-8','Alto','ParcialB1');
INSERT INTO Externo (Loja_CNPJ,Funcionario_CPF,Grau_de_responsabilidade,Tipo_de_acesso) VALUES('23.13.131/112-12', '000.000.000-9','Baixo','ParcialB2');
INSERT INTO Externo (Loja_CNPJ,Funcionario_CPF,Grau_de_responsabilidade,Tipo_de_acesso) VALUES('86.814.375/0001-00', '000.000.000-0','Baixo','ParcialB3');

#Promocao_Loja

INSERT INTO Promocao_Loja (Loja_CNPJ, Promocao_Codigo, categoria, Porcentagem, Descricao_Promocao, Data_inicio, Data_fim)
VALUES ('86.814.375/0001-00', 26540, 'Calçados', 12.40, 'in ante vestibulum ante ipsum primis in faucibus orci', TO_DATE('12/07/2014', 'dd/mm/yyyy'), TO_DATE('18/12/2014', 'dd/mm/yyyy'));

INSERT INTO Promocao_Loja (Loja_CNPJ, Promocao_Codigo, categoria, Porcentagem, Descricao_Promocao, Data_inicio, Data_fim)
VALUES ('83.824.371/0001-00', 21807, 'Vestidos', 29.57, 'natoque penatibus et magnis dis parturient montes nascetur', TO_DATE('09/07/2014', 'dd/mm/yyyy'), TO_DATE('29/09/2014', 'dd/mm/yyyy'));

INSERT INTO Promocao_Loja (Loja_CNPJ, Promocao_Codigo, categoria, Porcentagem, Descricao_Promocao, Data_inicio, Data_fim)
VALUES ('33.824.141/0002-00', 21971, 'Eletrônicos', 33.65, 'duis at velit eu est congue elementum', TO_DATE('12/06/2014', 'dd/mm/yyyy'), TO_DATE('15/12/2014', 'dd/mm/yyyy'));

INSERT INTO Promocao_Loja (Loja_CNPJ, Promocao_Codigo, categoria, Porcentagem, Descricao_Promocao, Data_inicio, Data_fim)
VALUES ('13.14.141/132-00', 89937, 'Óculos de grau', 21.48, 'urna pretium nisl ut volutpat sapien', TO_DATE('11/09/2014', 'dd/mm/yyyy'), TO_DATE('12/09/2014', 'dd/mm/yyyy'));

INSERT INTO Promocao_Loja (Loja_CNPJ, Promocao_Codigo, categoria, Porcentagem, Descricao_Promocao, Data_inicio, Data_fim)
VALUES ('13.11.111/112-00', 1234, 'Televisões', 47.72, 'hac habitasse platea dictumst morbi vestibulum', TO_DATE('01/04/2014', 'dd/mm/yyyy'), TO_DATE('03/02/2015', 'dd/mm/yyyy'));

INSERT INTO Promocao_Loja (Loja_CNPJ, Promocao_Codigo, categoria, Porcentagem, Descricao_Promocao, Data_inicio, Data_fim)
VALUES ('23.13.131/112-12', 89316, 'Consolas', 62.39, 'in hac habitasse platea dictumst etiam faucibus cursus urna ut', TO_DATE('18/09/2014', 'dd/mm/yyyy'), TO_DATE('29/12/2014', 'dd/mm/yyyy'));

INSERT INTO Promocao_Loja (Loja_CNPJ, Promocao_Codigo, categoria, Porcentagem, Descricao_Promocao, Data_inicio, Data_fim)
VALUES ('23.11.121/132-11', 75305, 'Remédios', 15.68, 'odio justo sollicitudin ut suscipit a feugiat', TO_DATE('16/09/2014', 'dd/mm/yyyy'), TO_DATE('29/09/2014', 'dd/mm/yyyy'));

INSERT INTO Promocao_Loja (Loja_CNPJ, Promocao_Codigo, categoria, Porcentagem, Descricao_Promocao, Data_inicio, Data_fim)
VALUES ('93.15.128/112-11', 39719, 'Celulares', 61.33, 'quisque porta volutpat erat quisque erat', TO_DATE('29/08/2014', 'dd/mm/yyyy'), TO_DATE('05/09/2014', 'dd/mm/yyyy'));
...
INSERT INTO Aloca (Funcionario_CPF, Area_Codigo, Evento_Codigo) VALUES ('000.000.000-2', 2, 3);
INSERT INTO Aloca (Funcionario_CPF, Area_Codigo, Evento_Codigo) VALUES ('000.000.000-3', 3, 2);
INSERT INTO Aloca (Funcionario_CPF, Area_Codigo, Evento_Codigo) VALUES ('000.000.000-4', 4, 5);
INSERT INTO Aloca (Funcionario_CPF, Area_Codigo, Evento_Codigo) VALUES ('000.000.000-5', 5, 6);
